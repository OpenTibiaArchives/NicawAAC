...
<?php
$SQL = new SQL();
$SQL->myQuery('SELECT name, expires FROM bans, players WHERE bans.type = 2 AND players.id = bans.value OR bans.type = 3 AND players.account_id = bans.value ORDER BY expires ASC');
if ($SQL->failed()) 
